...
\paragraph{Outline.}
Section~\ref{sec:model} presents the model environment, defines the two polar
communication regimes, and characterizes equilibrium in each period.
Section~\ref{sec:welfare} compares welfare under forward guidance and opacity.
Section~\ref{sec:extensions} extends the analysis to two intermediate regimes---the
constant-rate conditional forecasts of the SNB and the market-rate conditional
forecasts of the BOE---and characterizes scenario-based communication.
